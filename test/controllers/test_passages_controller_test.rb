...
class TestPassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_passage" do
    assert_difference('TestPassage.count') do
      post test_passages_url, params: { test_passage: { correct_questions: @test_passage.correct_questions } }
    end
  ...
  test "should update test_passage" do
    patch test_passage_url(@test_passage), params: { test_passage: { correct_questions: @test_passage.correct_questions } }
